...
include_once(SMARTSHOP_ROOT_PATH . "class/dbupdater.php");      

$dbupdater = new SmartcontentDbupdater();
...
switch ( $op )
{
    ...
    default:
        header("Location: ".SMARTSHOP_URL."admin/index.php");
        break;
}
...
function checkTables()
{
    ...
    xoops_cp_header();
    smartshop_adminmenu(-1, _AM_SSHOP_DB_CHECKTABLES);
    //1. Determine previous release
    if (!smartshop_TableExists('smartshop_meta')) {
        $ver = '0.93';
    } else {
        if (!$ver = smartshop_GetMeta('version')) {
    ...
    printf('<h2>'._AM_SSHOP_DB_CURRENTVER.'</h2>', $currentVer);
    printf('<h2>'._AM_SSHOP_DB_DBVER.'</h2>', $ver);

    
    if ($ver == $currentVer) {
        //No updates are necessary
        echo '<div>'._AM_SSHOP_DB_NOUPDATE.'</div>';
        
    } elseif ( $ver < $currentVer) {
        //Needs to upgrade
        echo '<div>'._AM_SSHOP_DB_NEEDUPDATE.'</div>';
        echo "<form method=\"post\" action=\"upgrade.php\"><input type=\"hidden\" name=\"op\" value=\"upgradeDB\" /><input type=\"submit\" value=\"". _AM_SSHOP_DB_UPDATE_NOW . "\" /></form>";
    } else {
        //Tried to downgrade
        echo '<div>'._AM_SSHOP_DB_NEEDINSTALL.'</div>';
    }
...
function upgradeDB()
{
    ...
    xoops_cp_header();
    smartshop_adminMenu(-1, _AM_SSHOP_DB_UPDATE_DB);
    echo "<h2>"._AM_SSHOP_DB_UPDATE_DB."</h2>";
    $ret = true;
...
/// SMARTSHOP 0.93 ////////////////////////////////////////////////   
    case '0.93':
        set_time_limit(60);
        printf("<h3>". _AM_SSHOP_DB_UPDATE_TO."</h3>", '1.0' );
        echo "<ul>";
        
        // Create table smartshop_meta
        $table = new SmartcontentTable('smartshop_meta');
        ...
        // Add fields in smartshop_categories
        $table = new SmartcontentTable('smartshop_categories');
        ...
        // Add fields in smartshop_items
        $table = new SmartcontentTable('smartshop_items');
        ...
        // Add fields in smartshop_files
        $table = new SmartcontentTable('smartshop_files');
...
/// SMARTSHOP 1.0 ////////////////////////////////////////////////        
    case '1.0':
    	set_time_limit(60);
        printf("<h3>". _AM_SSHOP_DB_UPDATE_TO."</h3>", '1.01' );
        echo "<ul>";
...
/// SMARTSHOP 1.0.1 ////////////////////////////////////////////////      
    case '1.01':
    	set_time_limit(60);
        printf("<h3>". _AM_SSHOP_DB_UPDATE_TO."</h3>", '1.02' );
        echo "<ul>";
        
        // Create table smartshop_mimetypes
        $table = new SmartcontentTable('smartshop_mimetypes');
        $table->setStructure("CREATE TABLE %s (
...
/// SMARTSHOP 1.0.2 ////////////////////////////////////////////////      
    case '1.02':
    	set_time_limit(60);
        printf("<h3>". _AM_SSHOP_DB_UPDATE_TO."</h3>", '1.03' );
        echo "<ul>";
...
/// SMARTSHOP 1.0.3 ////////////////////////////////////////////////      
       case '1.03':
    	set_time_limit(60);
        printf("<h3>". _AM_SSHOP_DB_UPDATE_TO."</h3>", '1.04' );
        echo "<ul>";
...
/// SMARTSHOP 1.0.4 ////////////////////////////////////////////////      
       case '1.04':
    	set_time_limit(60);
        printf("<h3>". _AM_SSHOP_DB_UPDATE_TO."</h3>", '1.05' );
        echo "<ul>";
...
/// SMARTSHOP 1.0.5 ////////////////////////////////////////////////      
       case '1.05':
    	set_time_limit(60);
        printf("<h3>". _AM_SSHOP_DB_UPDATE_TO."</h3>", '1.1' );
        echo "<ul>";
...
/// SMARTSHOP 1.1 ////////////////////////////////////////////////      
       case '1.1':
    	set_time_limit(60);
        printf("<h3>". _AM_SSHOP_DB_UPDATE_TO."</h3>", '2.0' );
        echo "<ul>";
        ...
        if (!smartshop_TableExists('smartshop_mimetypes')) {
	        // Create table smartshop_mimetypes
	        $table = new SmartcontentTable('smartshop_mimetypes');
	        $table->setStructure("CREATE TABLE %s (
	  							  mime_id int(11) NOT NULL auto_increment,
        ...
        $table = new SmartcontentTable('smartshop_categories');
        $table->addNewField('header', "`header` TEXT NOT NULL");
    ...
    //if successful, update smartshop_meta table with new ver
    if ($ret) {
        printf(_AM_SSHOP_DB_UPDATE_OK, $newversion);
        $ret = smartshop_SetMeta('version', $newversion);
    } else {
        printf(_AM_SSHOP_DB_UPDATE_ERR, $newversion);
    }
